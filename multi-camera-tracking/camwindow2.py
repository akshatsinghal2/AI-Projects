...
class CamWindow2:
        ...
        def run_detection():
            ...
            while(time.time() - start_time) < duration:
                ...
                if ret:
                    ...
                    # Detect objects
                    results = model.track(frame, show = True, persist=True, classes=[0], save_crop=True, tracker="bytetrack.yaml", project = 'output/predict2', name="infer", exist_ok=True, conf = 0.8, device = self.device)
    ...
    def compare_images(self):
        ...
        # Define the folders to compare
            ...
            folder2 = "output/predict2/infer/crops/person"
        ...
        for filename in os.listdir(output_folder):
            if filename.endswith(".jpg"):
                ...
                with Image.open(os.path.join(output_folder, filename)) as img:
                    ...
                    png_filename = text_befor + os.path.splitext(filename)[0] + ".png"
